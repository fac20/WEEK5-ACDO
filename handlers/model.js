...
function getPostsData(){
 ...
 const add = async function(name, msgtitle, message) {
     try {
        ...
        let postInsertion = await db.query("INSERT INTO posts(post_title, text_content, user_id) VALUES($1, $2, (SELECT id FROM users WHERE username = $3 LIMIT 1)))", [msgtitle, message, name])
